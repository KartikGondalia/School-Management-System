                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="page-header clearfix">
                                                <h2 style="float:left">Update Teacher - <?php echo $id; ?></h2>				
                                            </div>
                                            <form class="forms-sample" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="teacheLastName">Teacher Last Name</label>
                                                ...
                                                if (isset($_POST['update'])){ 
                                                    ...
                                                    $className = trim($_POST['className']);
                                                        ...
                                                        if ($result = $conn->query($sql)) {
                                                            ...
                                                            echo "<script> alert('Teacher  ".$studentFirstName." ".$studentLastName." Record Updated Successfully!'); location.href='teacherViwe.php'; </script>";
                                                        } 
                                                        else {
                                                ...
                                                if (isset($_POST['Delete'])){
                                                    ...
                                                    if ($result = $conn->query($dsql) && $result = $conn->query($dsql2)) {
                                                        ...
                                                        echo "<script> alert('Teacher ".$firstName." ".$lastName." Record Deleted Successfully!'); location.href='teacherViwe.php'; </script>";
                                                    } 
                                                    else {
                                                        $errMSG = mysqli_error($conn);
                                                    }	
